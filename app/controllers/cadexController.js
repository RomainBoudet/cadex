...
const cadexController = {
    ...
    getCadex: async (req, res) => {
        ...
        res.status(200).json({cadex:baseCadex.glue(), info:"You can add verb, complement, adjective and name in JSON or urlencoded format in post request to https://cadex-api.thedev.fr/v1/cadex "});
    },
